        ...
        if (check == false) {
            ...
            for (var j = 0; j < links.length; j++) {
                if (!usedLinks.has(links[j])) {
                    ...
                    linktag[i].href = "https://www.blog-dnz.com/?=" + aesCrypto.encrypt(convertstr(linktag[i].href), convertstr('root')) + setting.path + aesCrypto.encrypt(feedLink, convertstr('root'));
